...
export default function DonationsForm() {
  ...
  return (
    <form
      ...
      className="bg-[rgba(255,255,255,0.05)] backdrop-blur-md border border-gold/30 rounded-xl p-8 max-w-xl mx-auto shadow-lg"
    >
      <h2 className="text-2xl font-serif text-gold mb-6 text-center">Donate Food or Funds</h2>
      {success && (
      ...
      <div className="mb-4">
        <label className="block mb-1 text-gold font-medium" htmlFor="amount">
          Donation Amount (₹)
        </label>
        <input
          className="w-full p-3 rounded bg-transparent border border-gold/40 text-ivory focus:border-gold outline-none transition"
      ...
      <div className="mb-6">
        <label className="block mb-1 text-gold font-medium" htmlFor="message">
          Message (optional)
        </label>
        <textarea
          className="w-full p-3 rounded bg-transparent border border-gold/40 text-ivory focus:border-gold outline-none transition"
